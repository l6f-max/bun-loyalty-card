...
function render(){
      ...
      html += `<div class="section">
        <div class="card center">
          ...
          ${S.authMode === "register" ? `
            ...
            <div class="muted" style="margin-bottom:6px;">كم طابع يحتاج العميل للمكافأة؟</div>
            <input id="stampsRequiredField" type="number" min="2" max="30" placeholder="مثال: 10" value="10" style="width:100%;margin-bottom:10px;text-align:center;" />
  ...
  if(S.view === "customer"){
    ...
    <div class="header">
      <div class="title">${headerIcon} <span>طوابع</span> <span style="font-size:12px;opacity:.7;margin-right:4px;">${headerLabel}</span></div>
      <div class="tag">${cafeRequired} طوابع = مكافأة مجانية</div>
      <div class="perf">${perf}</div>
    </div>`;
