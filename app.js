    ...
    if(!S.authed){
      ...
      html += `<div class="section">
        ...
        <div class="card">
          ...
          ` : `<p class="muted">لا يوجد سجل استبدال بعد. لو أنت متأكد إنه فيه مكافآت مستبدلة ولا تظهر هنا، يعني سجل المكافآت لسا ما انضاف بقاعدة البيانات (راجع تعليمات الإضافة من مطوّر الموقع).</p>`}
        </div>
        ` : ""}
